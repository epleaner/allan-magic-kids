  ...
  return (
    <>
      ...
      <Section>
        ...
        <div className='text-center max-sm:text-7xl text-[136px] text-orange font-bold'>
          Magic Al
        </div>
      ...
      <div className='absolute bottom-0'>
        ...
        />
        <div className='w-full absolute top-[-30px] max-sm:pr-[30px] pr-[60px] flex items-end justify-end z-20'>
          <Link href='/contact'>
